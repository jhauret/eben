...
def train():
    ...
    # Instantiate EBEN
    generator: torch.nn.Module = GeneratorEBEN(m=4,    # decimation factor of PQMF
                                               n=32,   # PQMF kernel size
                                               p=1)    # number of informative bands

    discriminator: torch.nn.Module = DiscriminatorEBENMultiScales(q=3)  # number of bands refined by PQMF discriminators

    eben: LightningModule = EBEN(generator=generator,
