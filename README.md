...
| Speech\Metrics | PESQ               | SI-SDR              | STOI                 | MUSHRA-I  (88 participants)        | MUSHRA-Q  (82
participants)        | Gen params     | Dis params      |
|------------------------------------------------------|--------------------|---------------------|----------------------|------------------|------------------|----------------|-----------------|
...
In the above Table: format is median (IQR). Significantly best values (acceptance=0.05) are in **bold**.
